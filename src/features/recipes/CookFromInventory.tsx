...
export default function CookFromInventory() {
  ...
  return (
    <div className="space-y-4">
      ...
      {detailLoading && <p className="text-sm text-stone-500">Lade Rezeptdetails …</p>}
          ...
          {matches.map((m) => {
            ...
            return (
              <button
                ...
                className="flex gap-3 overflow-hidden rounded-2xl border border-stone-200/70 bg-white p-3 text-left shadow-card transition-shadow hover:shadow-card-hover"
              >
                {m.thumbnail && (
                  <img
                    src={m.thumbnail}
