...
export default function RecipesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {mode === 'suche' && (
        <>
          <div className="inline-flex rounded-xl border border-stone-200 bg-stone-100 p-1 text-sm">
            {(
              [
          ...
          <form onSubmit={handleSearch} className="flex flex-wrap gap-2">
            <input
              ...
              className="min-w-[12rem] flex-1 rounded-xl border border-stone-300 px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
            />
      ...
      {loading && <p className="text-sm text-stone-500">Lade Rezepte …</p>}
      {detailLoading && (
        <p className="text-sm text-stone-500">Lade Rezeptdetails …</p>
      )}
      ...
      {mode === 'suche' && selected && !detailLoading && (
        <RecipeDetail
          ...
          onSave={() => savedRecipes.saveRecipe(selected)}
