      ...
      <Card className="space-y-4">
        ...
        <div className="flex flex-wrap items-end gap-4">
          <label className="flex flex-col text-sm text-stone-700">
            ...
            <select
              ...
              className="mt-1 rounded-xl border border-stone-300 px-2 py-1.5 text-sm"
            >
              {MEAL_TYPES.map((t) => (
          ...
          <label className="flex flex-col text-sm text-stone-700">
            ...
            <input
              ...
              className="mt-1 w-24 rounded-xl border border-stone-300 px-2 py-1.5 text-sm"
            />
          </label>
        ...
        {lists.length > 0 && (
          <div className="space-y-1">
            <p className="text-sm text-stone-700">Listen</p>
