  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="flex w-full items-center gap-3 rounded-2xl border-2 border-dashed border-emerald-300 bg-emerald-50 px-4 py-3.5 text-left shadow-sm transition-all duration-150 hover:border-emerald-400 hover:bg-emerald-100 hover:shadow-md active:scale-[0.99]"
      >
      ...
      <div className="flex items-center gap-3 pt-1 text-xs font-medium text-stone-400">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
        <input
          ...
          className="w-full min-w-0 flex-1 rounded-xl border border-stone-300 px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 sm:min-w-[10rem]"
        />
        <div className="grid grid-cols-2 gap-2 sm:contents">
          ...
          <select
            ...
            className="w-full rounded-xl border border-stone-300 px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 sm:w-auto"
          >
